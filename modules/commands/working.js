...
var coinscn = Math.floor(Math.random() * 1000) + 20; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 1000) + 20; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 1000) + 20; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 1000) + 20; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 1000) + 20; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 1000) + 20; //random coins khi đào đá
var coinsdd2 = Math.floor(Math.random() * 1000) + 10; //random coins công việc của Nguyễn Huy Hoàng
var coinsdd3 = Math.floor(Math.random() * 1000) + 10; //random coins công việc của Đồng Toàn
var coinsdd4 = Math.floor(Math.random() * 1000) + 10; //random coins công việc của Hoàng Đỗ Gia Nguyên
...
var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            ...
            if (msg == "⚡️Đợi Hoàng Nguyên update...") {
                msg = "⚡️Update soon...";
            };
